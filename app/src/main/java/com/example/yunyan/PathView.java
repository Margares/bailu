...
//        mPath = new Path();
        ...
        mPaint.setColor(Color.parseColor("#a1afc9"));
...
//    @Override
    protected void onDraw(Canvas canvas) {
        ...
        for (int j=1; j< 13; j++) {
            for (int k = 1; k < 4; k++) {
                mPaint.setColor(Color.parseColor("#b0a4e3"));;
...
//        显示时间与系统时间同步
        ...
        mPaint.setColor(Color.parseColor("#d6ecf0"));
        ...
        canvas.save();
        mPaint.setStrokeWidth(8);
        mPaint.setColor(Color.parseColor("#c0ebd7"));
        ...
        mPaint.setColor(Color.parseColor("#e3f9fd"));
